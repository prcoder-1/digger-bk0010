...
void init_level_state()
{
    ...
    if (difficulty > 6) bugs_max = 5;      // На уровне сложности 8 и выше максимально 5 врагов одновременно
    else if (difficulty > 0) bugs_max = 4; // На уровне сложности со 2 до 7 (включительно) до 4 врагов одновременно
    ...
    bugs_delay = 40 - (difficulty << 1); // Задержка появления врагов (с ростом сложности убывает)
